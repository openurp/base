...
ThisBuild / version := "0.4.69-SNAPSHOT"
...
val beangle_con = "org.beangle.cron" % "beangle-cron" % "0.0.1-SNAPSHOT"
...
lazy val ws = (project in file("ws"))
  ...
  .settings(
    ...
    common,
    libraryDependencies ++= Seq(openurp_base_api, openurp_stater_ws, beangle_con)
  )
