...
[@b.grid items=teachers var="teacher"]
  [@b.gridbar]
    ...
    bar.addItem("${b.text('action.export')}",action.exportData("staff.code:工号,name:姓名,department.name:院系,staff.title.name:职称,office.name:教研室,tqcNumber:教师资格证号码,oqc:其他职业资格证书和等级说明,beginOn:任教起始,endOn:任教结束,staff.status.name:在职状态",null,'fileName=教师信息'));
  [/@]
  [@b.row]
    [@b.boxcol /]
