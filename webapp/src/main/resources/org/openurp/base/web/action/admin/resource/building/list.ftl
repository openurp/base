...
[@b.grid items=buildings var="building"]
  ...
  [@b.row]
    ...
    [@b.col width="15%" property="buildingType.name" title="用途"/]
    [@b.col width="10%" property="beginOn" title="生效时间"]${building.beginOn!}[/@]
    [@b.col width="10%" property="endOn" title="失效时间"]${building.endOn!}[/@]
  [/@]
[/@]
[@b.foot/]
