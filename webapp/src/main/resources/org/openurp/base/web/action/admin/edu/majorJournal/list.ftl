...
[@b.grid items=majorJournals var="majorJournal"]
  ...
  [@b.row]
    ...
    [@b.col property="depart" title="院系"]${(majorJournal.depart.name)!}[/@]
    ...
    [@b.col width="10%" title="已有学生数"]${stdCountMap[majorJournal.level.id?string+"_"+majorJournal.depart.id?string]!0}[/@]
