...
[@b.toolbar title="修改培养层次"]bar.addBack();[/@]
  [@b.form action=b.rest.save(code) theme="list"]
    ...
    [@b.select name="code.fromLevel.id" label="起始" value=code.fromLevel! items=levels empty="..." required="true"/]
    [@b.select name="code.toLevel.id" label="到" value=code.toLevel! items=levels empty="..." required="true"/]
