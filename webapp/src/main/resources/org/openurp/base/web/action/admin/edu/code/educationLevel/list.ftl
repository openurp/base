...
[@b.grid items=educationLevels var="educationLevel"]
  ...
  [@b.row]
    ...
    [@b.col width="15%" title="层次"]${educationLevel.fromLevel.name} ～ ${educationLevel.toLevel.name}[/@]
    [@b.col width="15%" property="beginOn" title="生效日期"]${educationLevel.beginOn!}[/@]
    [@b.col width="15%" property="endOn" title="失效日期"]${educationLevel.endOn!}[/@]
  [/@]
[/@]
[@b.foot/]
