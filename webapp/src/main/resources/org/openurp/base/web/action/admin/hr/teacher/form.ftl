...
[@b.toolbar title="修改教师信息"]bar.addBack();[/@]
  [@b.form action=b.rest.save(teacher) theme="list"]
    ...
    [/#if]
    [@b.textfield name="teacher.tqcNumber" label="教师资格证号码" value=teacher.tqcNumber! maxlength="30" required=extraRequired?seq_contains("tqcNumber")?c/]
    ...
    [@b.select name="teacherProjectId" label="参与教学项目" required="true" items=projects values=teacher.projects! multiple="true"/]
