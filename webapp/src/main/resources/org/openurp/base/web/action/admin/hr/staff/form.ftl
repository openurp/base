...
[@b.toolbar title="修改教职工信息"]bar.addBack();[/@]
  [@b.form action=b.rest.save(staff) theme="list"]
    ...
    [@b.select name="staff.educationDegree.id" label="学历" value=staff.educationDegree! required=extraRequired?seq_contains("educationDegree")?c items=educationDegrees/]
