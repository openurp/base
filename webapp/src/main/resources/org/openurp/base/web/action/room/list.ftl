...
[@b.grid items=rooms var="room"]
  ...
  [@b.row]
    ...
    [@b.col width="10%" property="name" title="名称"][@b.a href="!info?id=${room.id}"]${room.name}[/@][/@]
    ...
    [@b.col width="15%" property="beginOn" title="生效时间"]${room.beginOn!}[/@]
    [@b.col width="15%" property="endOn" title="失效时间"]${room.endOn!}[/@]
  [/@]
[/@]
[@b.foot/]
