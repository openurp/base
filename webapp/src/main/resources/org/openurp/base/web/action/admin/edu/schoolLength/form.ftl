...
[@b.toolbar title="学习年限"]bar.addBack();[/@]
  ...
  [@b.form action=sa theme="list" action=b.rest.save(schoolLength)]
    ...
    [@b.select name="schoolLength.fromGrade.id" label="起始年级" value=schoolLength.fromGrade! items=grades required="true"/]
    [@b.select name="schoolLength.toGrade.id" label="截止年级" value=schoolLength.toGrade! items=grades required="false"/]
