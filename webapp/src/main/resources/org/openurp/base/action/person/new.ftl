...
[@b.tabs]
  [@b.form action="!save" theme="list"]
    ...
    [@b.select name="person.gender.id" label="性别" value=(person.gender.id)! empty="..."
               style="width:200px;"  href=urp.service("/base/code/gender")  required="true"/]
    ...
    [@b.select name="person.department.id" label="所在部门" value="${person.department!}" 
               style="width:200px;" href=urp.service("/base/department") empty="..."/]
    [@b.select name="person.category.id" label="人员分类" value="${person.category!}" style="width:200px;" 
        href=urp.service("/base/code/person-category")/]
    ...
    [@b.select name="person.country.id" label="所在国家地区" value="${(person.country.id)!}" 
               style="width:200px;" href=urp.service("/base/code/country") empty="..."/]
