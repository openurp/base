...
import org.beangle.data.model.bean.{ CodedBean, NamedBean, NumIdBean, TemporalOnBean }
 ...
 */
class CalendarBean extends NumIdBean[Int] with CodedBean with NamedBean with TemporalOnBean with Calendar {
 ...
 */
class SemesterBean extends NumIdBean[Int] with CodedBean with NamedBean with TemporalOnBean with Semester {
  /**日历*/
