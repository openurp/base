...
[@b.grid items=teachers var="teacher"]
  ...
  [@b.row]
    ...
    [/#if]
    [@b.col width="10%" property="staff.degree.name" title="学位"/]
    ...
    [@b.col width="8%" property="beginOn" title="任教起始"]${teacher.beginOn?string('yyyy-MM')}~${(teacher.endOn?string('yyyy-MM'))!'至今'}[/@]
  [/@]
[/@]
[@b.foot/]
