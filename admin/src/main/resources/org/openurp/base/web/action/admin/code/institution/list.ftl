...
[@b.grid items=institutions var="institution"]
  ...
  [@b.row]
    ...
    [@b.col property="enName" title="英文名称"]${institution.enName!}[/@]
    [@b.col width="15%" property="beginOn" title="生效时间"]${institution.beginOn!}[/@]
    [@b.col width="15%" property="endOn" title="失效时间"]${institution.endOn!}[/@]
  [/@]
[/@]
[@b.foot/]
